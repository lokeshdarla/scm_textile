...
import { useActiveAccount, useConnect, useContractEvents, useReadContract, useSendAndConfirmTransaction } from 'thirdweb/react'
...
export default function FarmerDashboard() {
  ...
  // Fetch raw materials in useEffect
  useEffect(() => {
    fetchRawMaterials()
    // We're only calling this on mount or when activeAccount changes
  ...
  if (!activeAccount) {
    return (
      <div className="flex flex-col items-center justify-center h-[calc(100vh-64px)]">
        ...
        <Button className="mt-4 bg-primary hover:bg-primary/90" onClick={() => console.log(activeAccount)}>
          Connect Wallet
        </Button>
      </div>
    )
